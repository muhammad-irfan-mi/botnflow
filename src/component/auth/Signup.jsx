            ...
            <div className="w-[50%] flex flex-col items-center px-6 py-12 lg:px-8">
                <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-lg">
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <h2 className="ml-3 text-2xl font-bold text-gray-900">BOTnFLOW</h2> */}
                        <img src={logo} alt="" className='w-60' />
                    </div>

                    {/* Welcome Text */}
                    <div className="text-center">
                        <p className="mt-2 text-sm text-gray-600">Sign Up to access your account</p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <Link to='/' className='font-medium text-primary-600 hover:text-brand-500 cursor-pointer ml-1'>
                                Login for Account!
                            </Link>
                        </p>
                    </div>
